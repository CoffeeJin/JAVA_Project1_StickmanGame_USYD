...
public class ControllableDynamicEntity<T extends DynamicEntity> extends DynamicEntity {
    ...
    public ControllableDynamicEntity(
            ControllableDynamicEntity controllableDynamicEntity, Level level) {
        this.entity =(T) new DynamicEntityImpl((DynamicEntityImpl)controllableDynamicEntity.entity,level);
        this.maxHorizontalVelocity = controllableDynamicEntity.maxHorizontalVelocity;
        this.floorHeight = controllableDynamicEntity.floorHeight;
        this.gravity = controllableDynamicEntity.gravity;
        this.startingPosition = new Vector2D(controllableDynamicEntity.startingPosition.getX(),controllableDynamicEntity.startingPosition.getY());
    }
