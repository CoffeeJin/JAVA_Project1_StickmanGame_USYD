...
public class DynamicEntityImpl extends DynamicEntity {
    ...
    public DynamicEntityImpl(
            DynamicEntityImpl dynamicEntity, Level level
            ) {
        this.kinematicState = dynamicEntity.kinematicState.copy();
        this.volume = dynamicEntity.volume.copy();
        this.layer = dynamicEntity.layer;
        this.image = dynamicEntity.image;
        this.collisionStrategy = dynamicEntity.collisionStrategy.copy(level);
        this.behaviourStrategy = dynamicEntity.behaviourStrategy.copy(level);
    }
